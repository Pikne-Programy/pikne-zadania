  ...
  describe('Fetching', () => {
    describe('getTeams', () => {
      ...
      it(
        ...
        waitForAsync(
          inject([TeamService, HttpClient], (service: TeamService) => {
            ...
            const req = httpController.expectOne(ServerRoutes.teamList);
      ...
      it(
        ...
        waitForAsync(
          inject([TeamService, HttpClient], (service: TeamService) => {
            ...
            spyOnProperty(Types, 'isTeamItemList').and.returnValue(spy as any);
      ...
      it(
        ...
        waitForAsync(
          inject([TeamService, HttpClient], (service: TeamService) => {
            ...
            service
              .getTeams()
              .then((response) => expect(response).toEqual(teamList))
        ...
        it(
          ...
          waitForAsync(
            inject([TeamService, HttpClient], (service: TeamService) => {
              ...
              const req = httpController.expectOne(ServerRoutes.team);
              expect(req.request.method).toEqual('POST');
              expect(req.request.body).toEqual({ id: TeacherTeamId });
              if (response === null)
      ...
      it(
        ...
        waitForAsync(
          inject([TeamService, HttpClient], (service: TeamService) => {
            ...
            service
              .getAssigneeList()
              .then((response) => expect(response).toEqual(members))
              .catch(() => fail('should resolve'));
            const req = httpController.expectOne(ServerRoutes.team);
            expect(req.request.method).toEqual('POST');
            expect(req.request.body).toEqual({ id: TeacherTeamId });
        ...
        it(
          ...
          waitForAsync(
            inject([TeamService, HttpClient], (service: TeamService) => {
              ...
              const promise = service.setAssignee(id, assignee);
              expectTeamModRequest(
                promise,
                httpController,
                ServerRoutes.teamUpdate,
        ...
        it(
          ...
          waitForAsync(
            inject([TeamService, HttpClient], (service: TeamService) => {
              ...
              const promise = service.openTeam(id, invitation);
              expectTeamModRequest(
                promise,
                httpController,
                ServerRoutes.teamUpdate,
