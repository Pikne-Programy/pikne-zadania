...
**note**: `done` property is stated only when the user is authorized and `raw` is `false`, it can be `null` or a number from 0 up to and including 1, see [#24](https://github.com/Pikne-Programy/pikne-zadania/issues/24#issuecomment-782939873).
