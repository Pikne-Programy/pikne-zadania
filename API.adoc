...
v0.5, 2022-05-27: Revision ⦲ (U+29B2)
...
// add to `It can be used by` if so:
// or all teachers if a subject's `assignees` equals `null`.
...
----
{
  “exercises”: [ “fizyka/pociagi-dwa-1”,“fizyka/pociagi-dwa-2”,“fizyka/pociagi-dwa-3”,“fizyka/pociagi-dwa-4” ], 
  “report”: [
    {
...
* `report.exercises` type is a tuple with the same length as `exercises`
// report.exercises-enum
* `report.exercises` is a tuple with four possible states, i. e.
** `☐` (U+2610) - unattempted
** `☒` (U+2612) - incorrect
** `⚀` (U+2680) - parial
** `☑` (U+2611) - correct
...
----
{
    “name”: “report_2_2022-05-26T23:33:36+02:00.txt”
}
----
...
// generated-report
* The generated report will be available at `https://zadania.infa8lo.pl/session/static/report_2_2022-05-26T23:33:36+02:00.txt` (see /api/session/static/:filename).
...
{
  “reports”: [
    “report_2_2022-05-26T23:33:36+02:00.txt”,
...
----
{
  “report”: “report_3.14_2022-05-27T01:33:66+02:00.txt”
}
----
